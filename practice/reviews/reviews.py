""" A practice exercise to read databases of businesses, users, and reviews, and return grouping information."""
...
def get_reviews_for_business(name, reviews):
    """Takes in a user name and returns aReturns all reviews for a given business in a list.
...
def get_all_users_from_single_city(users, city):
    ...
    >>> get_all_users_from_single_city([{"user_name": "Abby", "hometown": "Portland"},
    ... {"user_name": "Helen", "hometown": "Bugs"}],['Portland'])
    'Abby'
    """
...
def get_all_ratings_from_user_names(users_from_city, reviews):
    ...
    >>> get_all_ratings_from_user_names('Carmen',
